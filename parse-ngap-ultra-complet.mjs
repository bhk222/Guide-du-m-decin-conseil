...
const actesModernes = [
    ...
    { code: '9012', codeNGAP: 'R 50', lettreCle: 'R', coefficient: 50, libelle: 'Échographie abdominale', section: 'ECHOGRAPHIE', chapter: 'Échographie' },
    { code: '9013', codeNGAP: 'R 40', lettreCle: 'R', coefficient: 40, libelle: 'Échographie pelvienne', section: 'ECHOGRAPHIE', chapter: 'Échographie' },
    { code: '9014', codeNGAP: 'R 40', lettreCle: 'R', coefficient: 40, libelle: 'Échographie obstétricale', section: 'ECHOGRAPHIE', chapter: 'Échographie' },
    { code: '9015', codeNGAP: 'R 35', lettreCle: 'R', coefficient: 35, libelle: 'Doppler vasculaire', section: 'ECHOGRAPHIE', chapter: 'Doppler' },
    // Consultations
