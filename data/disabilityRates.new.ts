...
export const disabilityData: InjuryCategory[] = [
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Hématome intracrânien post-traumatique (sous-dural, extra-dural, intra-cérébral)", searchTerms: ["hematome intracranien", "hematome sous dural", "hematome sous-dural", "hematome extradural", "hematome extra-dural", "hematome extra dural", "hematome intra cerebral", "hematome subdural", "hematome epidural", "sous dural chronique", "sous dural aigu", "extradural", "intracranien", "hematome cerebral", "hematome cranien", "evacuation hematome"], rate: [10, 60], rateCriteria: { low: "Hématome traité conservativement ou évacué chirurgicalement sans séquelles neurologiques majeures. Syndrome post-commotionnel résiduel léger.", medium: "Hématome évacué chirurgicalement avec déficits neurologiques modérés résiduels (hémiparésie légère, troubles cognitifs). Nécessite suivi neurologique.", high: "Évacuation chirurgicale avec déficits neurologiques sévères persistants (hémiplégie, épilepsie post-traumatique, troubles cognitifs majeurs)." } },
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Syndrome Cérébelleux Bilatéral", searchTerms: ["syndrome cérébelleux bilatéral", "bilatéral cérébelleux syndrome", "syndrome cérébelleux", "cérébelleux bilatéral", "ataxie cérébelleuse bilatérale", "cérébelleux post traumatique"], rate: [30, 100] },
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Hémiplégie complète avec contracture (Côté Droit)", searchTerms: ["hémiplégie complète avec contracture côté droit", "droit côté contracture avec complète hémiplégie", "hémiplégie complète contracture côté droit", "hémiplégie complète", "complète avec", "hémiplégie droite complète contracture", "hémiplégie droite contracture"], rate: [70, 80] },
          ...
          // 🆕 V3.3.267 - Déficits sensitifs isolés (barème indicatif)
          { name: "Déficits sensitifs isolés hémi-corporels (d'origine cérébrale)", searchTerms: ["déficits sensitifs isolés hémi-corporels origine cérébrale", "déficit sensitif hémicorporel", "hémi-anesthésie cérébrale", "troubles sensitifs hémicorporels"], rate: [5, 25], description: "Déficits sensitifs hémi-corporels isolés sans déficit moteur, d'origine cérébrale.", rateCriteria: { low: "Hypoesthésie discrète, gêne fonctionnelle minime.", high: "Anesthésie complète hémicorporelle avec troubles proprioceptifs et risque d'automutilation." } },
          { name: "Douleurs de déafférentation (anciennement douleurs thalamiques)", searchTerms: ["douleurs déafférentation douleurs thalamiques", "douleurs thalamiques", "déafférentation douleur", "syndrome thalamique douloureux"], rate: [8, 25], description: "Douleurs neuropathiques centrales par lésion des voies sensitives (thalamus ou voies spinothalamiques). Anciennement 'douleurs thalamiques'.", rateCriteria: { low: "Douleurs intermittentes, contrôlées par traitement.", high: "Douleurs permanentes invalidantes, rebelles au traitement, avec allodynie." } },
        ]
      },
      {
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          // 🆕 V3.3.267 - Paralysies MI manquantes (barème indicatif)
          { name: "Paralysie du nerf fémoro-cutané (méralgie paresthésique isolée)", searchTerms: ["paralysie nerf fémoro-cutané méralgie paresthésique isolée", "paralysie fémoro cutané", "nerf fémoro cutané paralysie"], rate: 5, description: "Paralysie isolée du nerf fémoro-cutané latéral : taux < 5% selon le barème indicatif." },
          { name: "Paralysie isolée du nerf obturateur", searchTerms: ["paralysie isolée nerf obturateur", "nerf obturateur paralysie isolée", "paralysie obturateur isolée"], rate: 5, description: "Paralysie isolée du nerf obturateur : déficit d'adduction de la cuisse. Taux fixé à 5% selon le barème indicatif." },
        ]
      },
      {
        name: "Nerfs du Tronc",
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          // 🆕 V3.3.267 - Syndrome de Frei (barème indicatif Chap. IV Stomatologie)
          { name: "Syndrome de Frei (syndrome auriculo-temporal)", searchTerms: ["syndrome frei syndrome auriculo-temporal", "syndrome frei", "syndrome auriculo temporal", "frei auriculo temporal"], rate: 3, description: "Sudation faciale lors de la mastication (syndrome du nerf auriculo-temporal). Séquelle fréquente de chirurgie parotidienne ou de traumatisme de la région pré-auriculaire." },
        ]
      },
      {
      ...
      },
      {
        ...
        injuries: [
          { name: "Cécité complète", searchTerms: ["cécité complète", "cécité bilatérale", "cécité totale", "cécité complète bilatérale", "aveugle deux yeux", "perte totale vision bilatérale"], rate: 100 },
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Scotomes centraux (deux yeux)", searchTerms: ["scotomes centraux deux yeux", "yeux deux centraux scotomes", "scotomes centraux", "centraux deux", "deux yeux", "scotomes centraux bilatéraux", "scotome central bilatéral"], rate: [40, 100] },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Fibrose pulmonaire post-traumatique (hors pneumoconiose)", searchTerms: ["fibrose pulmonaire post traumatique hors pneumoconiose", "fibrose poumon post traumatique hors pneumoconiose", "pneumoconiose hors traumatique post pulmonaire fibrose", "fibrose pulmonaire", "pulmonaire post", "séquelles fibrosantes pulmonaires", "contusion pulmonaire séquelles fibrosantes", "syndrome restrictif post traumatique", "fibrose post contusion pulmonaire"], rate: [10, 60], rateCriteria: { low: "Images radiologiques discrètes, sans retentissement fonctionnel respiratoire notable.", high: "Fibrose étendue avec insuffisance respiratoire chronique confirmée par EFR." } },
      ...
      },
      {
        ...
        injuries: [
          ...
          // 🆕 V3.3.267 - Hépatites, cirrhoses, transplant hépatique (barème indicatif Chap. IX)
          { name: "Hépatite chronique — métavir ≤ A1F1 (activité minime, fibrose minime)", searchTerms: ["hépatite chronique métavir A1F1 activité minime fibrose minime", "hépatite chronique A1F1", "hépatite métavir A1 F1"], rate: 5, description: "Hépatite chronique avec activité et fibrose minimes (score métavir A1F1 ou inférieur)." },
          { name: "Hépatite chronique — métavir > A1F1 < F4 (activité/fibrose significative)", searchTerms: ["hépatite chronique métavir A1F1 F4 activité fibrose significative", "hépatite chronique stade intermédiaire", "hépatite métavir F2 F3"], rate: [5, 10], description: "Hépatite chronique avec fibrose significative mais sans cirrhose (métavir F2-F3)." },
          { name: "Hépatite chronique — arthromyalgies associées", searchTerms: ["hépatite chronique arthromyalgies associées", "arthromyalgies hépatite chronique", "douleurs articulaires hépatite"], rate: 10, description: "Arthralgies et myalgies associées à une hépatite chronique." },
          { name: "Hépatite chronique — vascularite", searchTerms: ["hépatite chronique vascularite", "vascularite hépatite chronique", "vascularite post-hépatique"], rate: [10, 50], description: "Vascularite systémique associée à une hépatite chronique (ex: périartérite noueuse, cryoglobulinémie).", rateCriteria: { low: "Vascularite cutanée limitée.", high: "Vascularite sévère avec atteinte rénale, neurologique ou multi-organes." } },
          { name: "Cirrhose Child-Pugh A (compensée)", searchTerms: ["cirrhose child-pugh A compensée", "cirrhose child A", "cirrhose compensée stade A"], rate: [10, 20], description: "Cirrhose hépatique compensée (score Child-Pugh A : 5-6 points)." },
          { name: "Cirrhose Child-Pugh B (modérément décompensée)", searchTerms: ["cirrhose child-pugh B modérément décompensée", "cirrhose child B", "cirrhose décompensée stade B"], rate: [20, 40], description: "Cirrhose hépatique modérément décompensée (score Child-Pugh B : 7-9 points)." },
          { name: "Cirrhose Child-Pugh C (sévèrement décompensée)", searchTerms: ["cirrhose child-pugh C sévèrement décompensée", "cirrhose child C", "cirrhose décompensée sévère stade C"], rate: 60, description: "Cirrhose hépatique sévère avec insuffisance hépatique grave (score Child-Pugh C : 10-15 points). Taux ≥ 60%." },
          { name: "Transplant hépatique (greffe de foie)", searchTerms: ["transplant hépatique greffe foie", "greffe hépatique", "transplantation foie", "transplantation hépatique"], rate: 60, description: "Transplantation hépatique : taux ≥ 60% selon le barème indicatif. Le taux définitif dépend des séquelles résiduelles et du traitement immunosuppresseur." },
        ]
      },
      {
        ...
        injuries: [
          ...
          // 🆕 V3.3.267 - Sténose urètre par fréquence de dilatation (barème indicatif Chap. XII)
          { name: "Sténose urétrale — 1 à 2 dilatations par an", searchTerms: ["sténose urétrale 1 2 dilatations par an", "sténose urètre dilatations annuelles", "rétrécissement urètre dilatations"], rate: 5, description: "Sténose urétrale nécessitant 1 à 2 dilatations par an." },
          { name: "Sténose urétrale — plus de 10 dilatations par an", searchTerms: ["sténose urétrale plus 10 dilatations par an", "sténose urètre fréquentes dilatations", "rétrécissement urètre fréquent"], rate: 10, description: "Sténose urétrale sévère nécessitant plus de 10 dilatations par an." },
        ]
      }
    ]
  },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Désarticulation du poignet (Main Dominante)", searchTerms: ["désarticulation poignet main dominante", "amputation transcarpienne main dominante", "transcarpienne", "désarticulation poignet", "amputation poignet", "perte main niveau poignet"], description: "Désarticulation au niveau de l'articulation du poignet, main dominante. Synonyme: amputation transcarpienne.", rate: [65, 70] },
          { name: "Désarticulation du poignet (Main Non Dominante)", searchTerms: ["désarticulation poignet main non dominante", "amputation transcarpienne main non dominante", "transcarpienne", "désarticulation poignet", "amputation poignet", "perte main niveau poignet"], description: "Désarticulation au niveau de l'articulation du poignet, main non dominante. Synonyme: amputation transcarpienne.", rate: [55, 60] },
        ]
       },
       {
      ...
      },
      {
       ...
       },
       {
        ...
        injuries: [
            ...
            { name: "Section des tendons fléchisseurs doigt long (Main Dominante)", searchTerms: ["section tendons fléchisseurs doigt long main dominante", "section tendon fléchisseur doigt", "tendons fléchisseurs doigt", "section fléchisseurs doigt"], rate: [8, 15], description: "Section des tendons fléchisseurs d'un ou plusieurs doigts longs, avec raideur séquellaire et perte de flexion active.", rateCriteria: { low: "Section 1 doigt, raideur modérée, flexion partielle.", medium: "Section 2-3 doigts, raideur séquellaire, perte fonctionnelle modérée.", high: "Section multiple doigts, raideur importante, perte de préhension." } },
            { name: "Section des tendons fléchisseurs doigt long (Main Non Dominante)", searchTerms: ["section tendons fléchisseurs doigt long main non dominante", "section tendon fléchisseur doigt", "tendons fléchisseurs doigt", "section fléchisseurs doigt"], rate: [6, 12], description: "Section des tendons fléchisseurs d'un ou plusieurs doigts longs.", rateCriteria: { low: "Section 1 doigt, raideur modérée.", medium: "Section 2-3 doigts, raideur séquellaire.", high: "Section multiple doigts, perte de préhension." } },
      ...
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Arthrodèses du coude (barème indicatif)
            { name: "Arthrodèse du coude en pronation (Main Dominante)", searchTerms: ["arthrodèse coude pronation main dominante", "arthrodèse coude en pronation", "fusion coude pronation"], rate: [20, 25], description: "Fusion osseuse du coude en position de pronation — main dominante." },
            { name: "Arthrodèse du coude en pronation (Main Non Dominante)", searchTerms: ["arthrodèse coude pronation main non dominante", "arthrodèse coude en pronation non dominante", "fusion coude pronation ND"], rate: [15, 20], description: "Fusion osseuse du coude en position de pronation — main non dominante." },
            { name: "Arthrodèse du coude en position neutre (Main Dominante)", searchTerms: ["arthrodèse coude position neutre main dominante", "arthrodèse coude neutre", "fusion coude neutre"], rate: 20, description: "Fusion osseuse du coude en position neutre — main dominante." },
            { name: "Arthrodèse du coude en position neutre (Main Non Dominante)", searchTerms: ["arthrodèse coude position neutre main non dominante", "arthrodèse coude neutre non dominante", "fusion coude neutre ND"], rate: 15, description: "Fusion osseuse du coude en position neutre — main non dominante." },
            { name: "Arthrodèse du coude en supination (Main Dominante)", searchTerms: ["arthrodèse coude supination main dominante", "arthrodèse coude en supination", "fusion coude supination"], rate: [25, 30], description: "Fusion osseuse du coude en position de supination — main dominante. Position la plus défavorable." },
            { name: "Arthrodèse du coude en supination (Main Non Dominante)", searchTerms: ["arthrodèse coude supination main non dominante", "arthrodèse coude en supination non dominante", "fusion coude supination ND"], rate: [20, 25], description: "Fusion osseuse du coude en position de supination — main non dominante." },
        ]
      },
      {
      ...
      },
      {
        ...
        injuries: [
            ...
            { name: "Ankylose du poignet - En flexion ou extension (Main Dominante)", searchTerms: ["ankylose poignet flexion extension main dominante", "dominante main extension flexion poignet ankylose", "ankylose poignet", "poignet flexion", "poignet extension"], rate: [30, 40] },
            { name: "Ankylose du poignet - En flexion ou extension (Main Non Dominante)", searchTerms: ["ankylose poignet flexion extension main non dominante", "dominante non main extension flexion poignet ankylose", "ankylose poignet", "poignet flexion", "poignet extension"], rate: [25, 35] },
            ...
            // 🆕 V3.3.267 - Arthrodèses du poignet (barème indicatif)
            { name: "Arthrodèse du poignet en position rectiligne (Main Dominante)", searchTerms: ["arthrodèse poignet position rectiligne main dominante", "arthrodèse poignet rectiligne", "fusion poignet rectiligne"], rate: 15, description: "Fusion osseuse chirurgicale du poignet en position rectiligne (bonne position) — main dominante." },
            { name: "Arthrodèse du poignet en position rectiligne (Main Non Dominante)", searchTerms: ["arthrodèse poignet position rectiligne main non dominante", "arthrodèse poignet rectiligne non dominante", "fusion poignet rectiligne ND"], rate: 10, description: "Fusion osseuse chirurgicale du poignet en position rectiligne — main non dominante." },
            { name: "Arthrodèse du poignet en position vicieuse (Main Dominante)", searchTerms: ["arthrodèse poignet position vicieuse main dominante", "arthrodèse poignet vicieuse", "fusion poignet position vicieuse"], rate: 20, description: "Fusion osseuse du poignet en position non fonctionnelle (flexion ou extension) — main dominante." },
            { name: "Arthrodèse du poignet en position vicieuse (Main Non Dominante)", searchTerms: ["arthrodèse poignet position vicieuse main non dominante", "arthrodèse poignet vicieuse non dominante", "fusion poignet vicieuse ND"], rate: 15, description: "Fusion osseuse du poignet en position vicieuse — main non dominante." },
        ]
      },
      {
      ...
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Préhension main, sensibilité, raideurs articulaires par articulation (barème indicatif)
            { name: "Perte de la préhension fine (atteinte motrice) (Main Dominante)", searchTerms: ["perte préhension fine atteinte motrice main dominante", "perte pince fine main dominante", "préhension fine perte main dominante"], rate: 30, description: "Perte de la capacité de préhension fine (pince pouce-index) par atteinte motrice — main dominante." },
            { name: "Perte de la préhension fine (atteinte motrice) (Main Non Dominante)", searchTerms: ["perte préhension fine atteinte motrice main non dominante", "perte pince fine main non dominante", "préhension fine perte main non dominante"], rate: 25, description: "Perte de la préhension fine par atteinte motrice — main non dominante." },
            { name: "Perte de la prise sphérique (Main Dominante)", searchTerms: ["perte prise sphérique main dominante", "prise sphérique perte main dominante", "perte prise globale main dominante"], rate: 6, description: "Perte de la capacité de saisie sphérique (empaumer un objet rond) — main dominante." },
            { name: "Perte de la prise sphérique (Main Non Dominante)", searchTerms: ["perte prise sphérique main non dominante", "prise sphérique perte main non dominante", "perte prise globale main non dominante"], rate: 5, description: "Perte de la prise sphérique — main non dominante." },
            { name: "Perte de la préhension grossière (Main Dominante)", searchTerms: ["perte préhension grossière main dominante", "préhension grossière perte main dominante", "perte force serrage main dominante"], rate: 40, description: "Perte de la capacité de serrage et de préhension en force (préhension globale) — main dominante." },
            { name: "Perte de la préhension grossière (Main Non Dominante)", searchTerms: ["perte préhension grossière main non dominante", "préhension grossière perte main non dominante", "perte force serrage main non dominante"], rate: 35, description: "Perte de la préhension en force — main non dominante." },
            { name: "Troubles de la sensibilité de la main — gêne modérée (Main Dominante)", searchTerms: ["troubles sensibilité main gêne modérée main dominante", "hypoesthésie main modérée dominante", "troubles sensitifs main modérés"], rate: [3, 5], description: "Hypoes thésie ou paresthésies gênant modérément les activités fines — main dominante." },
            { name: "Troubles de la sensibilité de la main — gêne modérée (Main Non Dominante)", searchTerms: ["troubles sensibilité main gêne modérée main non dominante", "hypoesthésie main modérée non dominante", "troubles sensitifs main modérés ND"], rate: [2, 4], description: "Hypoesthésie ou paresthésies gênant modérément les activités fines — main non dominante." },
            { name: "Troubles de la sensibilité de la main — gêne importante (Main Dominante)", searchTerms: ["troubles sensibilité main gêne importante main dominante", "anesthésie main importante dominante", "troubles sensitifs main importants"], rate: [5, 8], description: "Troubles sensitifs importants gênant significativement la préhension — main dominante." },
            { name: "Troubles de la sensibilité de la main — gêne importante (Main Non Dominante)", searchTerms: ["troubles sensibilité main gêne importante main non dominante", "anesthésie main importante non dominante", "troubles sensitifs main importants ND"], rate: [4, 6], description: "Troubles sensitifs importants — main non dominante." },
            { name: "Raideur métacarpo-phalangienne (II ou III) (Main Dominante)", searchTerms: ["raideur métacarpo-phalangienne II III main dominante", "raideur MCP index médius dominante", "raideur métacarpo-phalangienne doigt long"], rate: 4, description: "Raideur de l'articulation métacarpo-phalangienne d'un doigt long (index ou médius) — main dominante." },
            { name: "Raideur métacarpo-phalangienne (II ou III) (Main Non Dominante)", searchTerms: ["raideur métacarpo-phalangienne II III main non dominante", "raideur MCP index médius non dominante", "raideur métacarpo-phalangienne doigt long ND"], rate: 3, description: "Raideur de l'articulation MCP d'un doigt long — main non dominante." },
            { name: "Raideur articulation P1-P2 d'un doigt long (Main Dominante)", searchTerms: ["raideur articulation P1-P2 doigt long main dominante", "raideur IPP doigt long dominante", "raideur P1 P2 doigt"], rate: 3, description: "Raideur de l'articulation interphalangienne proximale (P1-P2) d'un doigt long — main dominante." },
            { name: "Raideur articulation P1-P2 d'un doigt long (Main Non Dominante)", searchTerms: ["raideur articulation P1-P2 doigt long main non dominante", "raideur IPP doigt long non dominante", "raideur P1 P2 doigt ND"], rate: 2, description: "Raideur IPP d'un doigt long — main non dominante." },
            { name: "Raideur articulation P2-P3 d'un doigt long (Main Dominante)", searchTerms: ["raideur articulation P2-P3 doigt long main dominante", "raideur IPD doigt long dominante", "raideur P2 P3 doigt"], rate: 2, description: "Raideur de l'articulation interphalangienne distale (P2-P3) d'un doigt long — main dominante." },
            { name: "Raideur articulation P2-P3 d'un doigt long (Main Non Dominante)", searchTerms: ["raideur articulation P2-P3 doigt long main non dominante", "raideur IPD doigt long non dominante", "raideur P2 P3 doigt ND"], rate: 2, description: "Raideur IPD d'un doigt long — main non dominante." },
            { name: "Raideur trapézo-métacarpienne du pouce (Main Dominante)", searchTerms: ["raideur trapézo-métacarpienne pouce main dominante", "raideur TMC pouce dominante", "raideur trapézo métacarpienne pouce"], rate: 8, description: "Raideur de l'articulation trapézo-métacarpienne du pouce (base du pouce) — main dominante." },
            { name: "Raideur trapézo-métacarpienne du pouce (Main Non Dominante)", searchTerms: ["raideur trapézo-métacarpienne pouce main non dominante", "raideur TMC pouce non dominante", "raideur trapézo métacarpienne pouce ND"], rate: 6, description: "Raideur TMC du pouce — main non dominante." },
            { name: "Raideur métacarpo-phalangienne du pouce (Main Dominante)", searchTerms: ["raideur métacarpo-phalangienne pouce main dominante", "raideur MCP pouce dominante", "raideur métacarpo phalangienne pouce"], rate: 6, description: "Raideur de l'articulation métacarpo-phalangienne du pouce — main dominante." },
            { name: "Raideur métacarpo-phalangienne du pouce (Main Non Dominante)", searchTerms: ["raideur métacarpo-phalangienne pouce main non dominante", "raideur MCP pouce non dominante", "raideur métacarpo phalangienne pouce ND"], rate: 4, description: "Raideur MCP du pouce — main non dominante." },
            { name: "Raideur interphalangienne du pouce (Main Dominante)", searchTerms: ["raideur interphalangienne pouce main dominante", "raideur IP pouce dominante", "raideur interphalangienne pouce"], rate: 2, description: "Raideur de l'articulation interphalangienne du pouce — main dominante." },
            { name: "Raideur interphalangienne du pouce (Main Non Dominante)", searchTerms: ["raideur interphalangienne pouce main non dominante", "raideur IP pouce non dominante", "raideur interphalangienne pouce ND"], rate: 2, description: "Raideur IP du pouce — main non dominante." },
        ]
      },
      {
      ...
      },
      {
        ...
        injuries: [
            ...
            { name: "Perte 4 doigts (sans pouce): Index + Médius + Annulaire + Auriculaire (Main Dominante)", searchTerms: ["perte doigts sans pouce index médius annulaire auriculaire main dominante", "amputation doigts sans pouce index médius annulaire auriculaire main dominante", "perte doigts"], rate: [30, 35] },
            { name: "Perte 4 doigts (sans pouce): Index + Médius + Annulaire + Auriculaire (Main Non Dominante)", searchTerms: ["perte doigts sans pouce index médius annulaire auriculaire main non dominante", "amputation doigts sans pouce index médius annulaire auriculaire main non dominante", "perte doigts"], rate: [25, 30] },
            // Amputation totale
            { name: "Amputation de tous les doigts de la main (Main Dominante)", searchTerms: ["amputation tous les doigts main main dominante", "dominante main main doigts les tous amputation", "amputation tous", "tous les", "les doigts"], rate: [55, 60] },
            { name: "Amputation de tous les doigts de la main (Main Non Dominante)", searchTerms: ["amputation tous les doigts main main non dominante", "dominante non main main doigts les tous amputation", "amputation tous", "tous les", "les doigts"], rate: [45, 50] },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Entrées manquantes du barème indicatif (Concours Médical 2001)
            { name: "Arthrodèse de hanche (fusion osseuse)", searchTerms: ["arthrodèse hanche fusion osseuse", "hanche arthrodèse fusion", "arthrodèse hanche"], rate: 20, description: "Fusion osseuse chirurgicale de l'articulation coxo-fémorale." },
            { name: "Arthrodèse de hanche en attitude vicieuse", searchTerms: ["arthrodèse hanche attitude vicieuse", "hanche arthrodèse vicieuse", "arthrodèse hanche vicieuse"], rate: [35, 40], description: "Fusion osseuse en position non fonctionnelle (flexum, adduction, rotation interne)." },
            { name: "Hanche ballante (après résection tête fémorale)", searchTerms: ["hanche ballante résection tête fémorale", "hanche ballante", "résection tête fémorale"], rate: 40, description: "Instabilité majeure après résection de la tête fémorale, sans prothèse." },
            { name: "Raideur de hanche en attitude vicieuse (flexum, rotation interne, adduction)", searchTerms: ["raideur hanche attitude vicieuse flexum rotation interne adduction", "raideur hanche vicieuse", "flexum hanche"], rate: [20, 25], description: "Raideur articulaire de hanche avec position vicieuse gênant la marche." },
            { name: "Raideur de hanche avec conservation uniquement de la flexion", searchTerms: ["raideur hanche conservation uniquement flexion", "raideur hanche flexion seule", "conservation flexion hanche"], rate: 15, description: "Seule la flexion est conservée, toutes les autres amplitudes sont perdues." },
            { name: "Limitation minime des amplitudes articulaires de la hanche", searchTerms: ["limitation minime amplitudes articulaires hanche", "limitation minime hanche", "amplitudes hanche minime"], rate: [3, 8], description: "Limitation discrète des amplitudes, gêne fonctionnelle minime.", rateCriteria: { low: "Limitation des mouvements extrêmes seulement.", high: "Limitation gênante dans le secteur utile (chaussage, montée d'escaliers)." } },
        ]
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Cals vicieux du fémur (barème indicatif)
            { name: "Cal vicieux du fémur - Raccourcissement jusqu'à 10 mm (compensé par talonnette)", searchTerms: ["cal vicieux fémur raccourcissement 10 mm talonnette", "raccourcissement fémur talonnette"], rate: 0, description: "Raccourcissement fémoral < 10 mm compensable par talonnette, pas d'incapacité." },
            { name: "Cal vicieux du fémur - Raccourcissement entre 10 et 50 mm", searchTerms: ["cal vicieux fémur raccourcissement 10 50 mm", "raccourcissement fémur 10 50 mm", "raccourcissement membre inférieur 10 50"], rate: [3, 8], description: "Raccourcissement nécessitant compensation orthopédique." },
            { name: "Cal vicieux du fémur - Raccourcissement au-delà de 50 mm", searchTerms: ["cal vicieux fémur raccourcissement 50 mm", "raccourcissement fémur supérieur 50 mm", "raccourcissement important membre inférieur"], rate: [8, 15], description: "Raccourcissement important avec retentissement fonctionnel majeur sur la marche." },
        ]
      },
      {
      ...
      },
       {
        ...
        injuries: [
            ...
            { name: "Fracture des plateaux tibiaux - Avec déviation et/ou raideur", searchTerms: ["fracture des plateaux tibiaux avec déviation et/ou raideur", "raideur et/ou déviation avec tibiaux plateaux des fracture", "fracture plateaux tibiaux déviation et/ou raideur", "fracture plateau tibial", "plateau tibial raideur", "fracture extremite superieure tibia", "fracture metaphysaire tibia"], rate: [10, 30] },
            { name: "Fracture des condyles fémoraux - Avec déviation et/ou raideur", searchTerms: ["fracture des condyles fémoraux avec déviation et/ou raideur", "raideur et/ou déviation avec fémoraux condyles des fracture", "fracture condyles fémoraux déviation et/ou raideur", "fracture condyle femoral", "condyle femoral raideur"], rate: [10, 30] },
      ...
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Entrées barème indicatif : genou flexion par angle, flexum, arthrodèse, laxités détaillées, rotule
            { name: "Arthrodèse du genou (fusion osseuse)", searchTerms: ["arthrodèse genou fusion osseuse", "genou arthrodèse fusion", "arthrodèse genou"], rate: 25, description: "Fusion osseuse chirurgicale du genou (absence totale de mobilité)." },
            { name: "Genou - Flexion possible de 0 à 30° seulement", searchTerms: ["flexion genou 0 30 degrés", "genou flexion limitée 30", "raideur genou 30 degrés"], rate: 20, description: "Flexion très limitée à 30° — gêne fonctionnelle majeure." },
            { name: "Genou - Flexion possible de 0 à 60°", searchTerms: ["flexion genou 0 60 degrés", "genou flexion limitée 60", "raideur genou 60 degrés"], rate: 15, description: "Flexion à 60° — gêne pour s'asseoir et monter les escaliers." },
            { name: "Genou - Flexion possible de 0 à 90°", searchTerms: ["flexion genou 0 90 degrés", "genou flexion limitée 90", "raideur genou 90 degrés"], rate: 10, description: "Flexion à 90° — position assise possible mais limitée." },
            { name: "Genou - Flexion possible de 0 à 110°", searchTerms: ["flexion genou 0 110 degrés", "genou flexion limitée 110", "raideur genou 110 degrés"], rate: [5, 8], description: "Limitation modérée de la flexion — gêne pour s'accroupir." },
            { name: "Genou - Flexion au-dessus de 110° (limitation minime)", searchTerms: ["flexion genou 110 degrés limitation minime", "genou flexion supérieure 110", "limitation minime flexion genou"], rate: [2, 5], description: "Limitation minime en fin de flexion du genou." },
            { name: "Flexum du genou de 0 à 10°", searchTerms: ["flexum genou 0 10 degrés", "flessum genou 10", "déficit extension genou 10"], rate: [2, 5], description: "Léger déficit d'extension du genou (flessum mineur)." },
            { name: "Flexum du genou de 10 à 20°", searchTerms: ["flexum genou 10 20 degrés", "flessum genou 20", "déficit extension genou 20"], rate: [5, 10], description: "Déficit d'extension modéré avec rétraction tendineuse." },
            { name: "Laxité antérieure du genou avec ressaut antéro-externe typique", searchTerms: ["laxité antérieure genou ressaut antéro-externe", "ressaut antéro-externe genou", "laxité antérieure ressaut"], rate: [5, 10], description: "Instabilité antérieure documentée avec pivot-shift reproduisant la gêne alléguée.", rateCriteria: { low: "Ressaut occasionnel, pas de dérobement dans les activités courantes.", high: "Ressaut fréquent avec dérobements lors de la marche en terrain irrégulier." } },
            { name: "Laxité antérieure du genou sans ressaut", searchTerms: ["laxité antérieure genou sans ressaut", "laxité antérieure isolée genou"], rate: [2, 5], description: "Tiroir antérieur positif mais sans instabilité rotatoire." },
            { name: "Laxité postérieure isolée du genou bien tolérée", searchTerms: ["laxité postérieure isolée genou tolérée", "laxité postérieure genou", "tiroir postérieur genou"], rate: [2, 5], description: "Tiroir postérieur isolé sans gêne fonctionnelle majeure." },
            { name: "Laxité chronique mixte périphérique et antéro-postérieure du genou", searchTerms: ["laxité chronique mixte périphérique antéro-postérieure genou", "laxité mixte genou", "instabilité multidirectionnelle genou"], rate: [5, 15], description: "Instabilité combinée dans plusieurs plans, avec retentissement fonctionnel important." },
            { name: "Laxité chronique grave du genou à la limite de l'arthrodèse", searchTerms: ["laxité chronique grave genou limite arthrodèse", "laxité grave genou", "instabilité majeure genou arthrodèse"], rate: 20, description: "Instabilité majeure rendant la marche très difficile sans appareillage." },
            { name: "Genou ballant appareillé (y compris raccourcissement)", searchTerms: ["genou ballant appareillé raccourcissement", "genou ballant", "pseudarthrose genou ballant"], rate: 30, description: "Instabilité totale du genou nécessitant un appareillage permanent." },
            { name: "Syndrome rotulien post-contusif (fémoro-patellaire)", searchTerms: ["syndrome rotulien post-contusif fémoro-patellaire", "syndrome rotulien contusion", "douleur rotulienne post-contusive"], rate: [1, 3], description: "Douleur rotulienne persistante après contusion directe de la rotule." },
            { name: "Syndrome rotulien après fracture de rotule", searchTerms: ["syndrome rotulien fracture rotule", "douleur rotulienne post-fracture", "syndrome fémoro-patellaire fracture rotule"], rate: [3, 8], description: "Douleurs et crépitation rotulienne séquellaires d'une fracture de rotule." },
            { name: "Rupture de l'appareil extenseur du genou (tendon rotulien/quadricipital) - Flexum actif résiduel", searchTerms: ["rupture appareil extenseur genou tendon rotulien quadricipital flexum actif", "rupture tendon rotulien", "rupture appareil extenseur genou"], rate: [3, 8], description: "Flexum actif persistant après réparation d'une rupture tendineuse du genou.", rateCriteria: { low: "Flexum actif discret (< 10°), force quadricipitale satisfaisante.", high: "Flexum actif important (> 20°) avec déficit de force majeur du quadriceps." } },
        ]
      },
      {
      ...
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Arthrodèses et équinismes cheville (barème indicatif)
            { name: "Arthrodèse tibio-talienne en bonne position", searchTerms: ["arthrodèse tibio-talienne bonne position", "arthrodèse cheville bonne position", "arthrodèse tibio-tarsienne"], rate: [10, 12], description: "Fusion osseuse tibio-talienne en position à angle droit — bonne position fonctionnelle." },
            { name: "Arthrodèse tibio-talienne + médio-talienne + sous-talienne (triple arthrodèse)", searchTerms: ["arthrodèse tibio-talienne médio-talienne sous-talienne triple arthrodèse", "triple arthrodèse cheville", "arthrodèse tibio médio sous talienne"], rate: 20, description: "Fusion de trois articulations de la cheville et de l'arrière-pied." },
            { name: "Perte de la flexion dorsale isolée de la cheville (genou fléchi)", searchTerms: ["perte flexion dorsale isolée cheville genou fléchi", "flexion dorsale isolée cheville", "perte flexion dorsale cheville"], rate: 5, description: "Perte isolée de la flexion dorsale de la cheville, mesurée genou fléchi." },
            { name: "Équinisme de la cheville < 2 cm", searchTerms: ["équinisme cheville inférieur 2 cm", "équin cheville léger", "équinisme mineur cheville"], rate: 5, description: "Déformation en équin (varus équin) de la cheville avec raccourcissement < 2 cm." },
            { name: "Équinisme de la cheville ≥ 2 cm avec médio-tarsienne normale", searchTerms: ["équinisme cheville 2 cm médio-tarsienne normale", "équin cheville médiotarsienne conservée", "équinisme 2 cm médio tarsienne"], rate: [5, 10], description: "Équinisme de 2 cm ou plus avec mobilité médio-tarsienne conservée." },
            { name: "Équinisme de la cheville ≥ 2 cm avec mobilité médio-tarsienne réduite", searchTerms: ["équinisme cheville 2 cm médio-tarsienne réduite", "équin cheville médiotarsienne diminuée", "équinisme médio-tarsienne réduite"], rate: 10, description: "Équinisme ≥ 2 cm avec mobilité médio-tarsienne réduite." },
            { name: "Équinisme de la cheville ≥ 2 cm sans mobilité médio-tarsienne", searchTerms: ["équinisme cheville 2 cm sans mobilité médio-tarsienne", "équin cheville médiotarsienne bloquée", "équinisme sans mobilité médio-tarsienne"], rate: 15, description: "Équinisme ≥ 2 cm avec médio-tarsienne ankylosée — retentissement majeur." },
            { name: "Équinisme de la cheville nécessitant un appareillage", searchTerms: ["équinisme cheville nécessitant appareillage", "équin cheville appareillé", "équinisme sévère cheville appareillage"], rate: 12, description: "Équinisme sévère nécessitant le port permanent d'un appareillage (releveur)." },
        ]
      },
      {
        name: "Pied - Fractures",
        injuries: [
            ...
            { name: "Fracture du calcanéum bilatérale - Avec douleurs et boiterie", searchTerms: ["fracture calcanéum bilatérale douleurs boiterie", "fracture calcanéum bilatéral", "calcanéum bilatérale", "calcanéum bilatéral", "fracture bilatérale calcanéum"], rate: [20, 45], description: "Fracture bilatérale du calcanéum avec retentissement fonctionnel sur les deux pieds. Taux majoré par rapport à l'atteinte unilatérale.", rateCriteria: { low: "Douleurs modérées bilatérales, marche possible avec semelles.", medium: "Douleurs importantes, boiterie bilatérale, périmètre de marche limité.", high: "Marche très limitée, impossibilité de station debout prolongée, arthrodèse sous-astragalienne bilatérale." } },
            { name: "Fracture des métatarsiens - Avec douleurs à la marche", searchTerms: ["fracture des métatarsiens", "fracture du métatarse", "fracture metatarsien", "fracture 5ème métatarse", "fracture phalange pied", "métatarse ou phalanges"], rate: [3, 10] },
        ]
      },
      {
        name: "Pied - Tendons",
        injuries: [
            { name: "Rupture du tendon d'Achille - Séquelles opératoires", searchTerms: ["rupture tendon achille séquelles", "tendon achille rupture", "rupture tendon d'achille", "achille rupture", "tendon achille opéré", "tendon achille", "rupture achille"], rate: [5, 15], rateCriteria: { low: "Rupture réparée chirurgicalement, récupération satisfaisante, légère diminution de la force de propulsion.", medium: "Rupture réparée avec séquelles : douleurs résiduelles, perte de force en flexion plantaire, gêne à la course et aux escaliers.", high: "Rupture ancienne ou échec chirurgical, allongement du tendon, perte significative de la force de propulsion, boiterie, impossibilité de se mettre sur la pointe des pieds." } },
            { name: "Rupture du tendon d'Achille non opérée", searchTerms: ["rupture tendon achille non opérée", "tendon achille non opéré", "achille non opéré", "rupture achille ancienne"], rate: [10, 25], rateCriteria: { low: "Cicatrisation spontanée avec allongement modéré, gêne fonctionnelle limitée.", medium: "Allongement significatif, perte de force importante en flexion plantaire.", high: "Absence de continuité fonctionnelle, impossibilité de flexion plantaire active contre résistance, marche avec compensation." } },
            { name: "Tendinopathie d'Achille post-traumatique chronique", searchTerms: ["tendinopathie achille post-traumatique", "tendinopathie achille chronique", "tendinite achille séquelles", "achille tendinopathie", "tendinopathie achille"], rate: [3, 8], description: "Tendinopathie chronique du tendon d'Achille post-traumatique avec douleurs persistantes." },
        ]
      },
      {
        name: "Pied - Pathologies des tissus mous",
        injuries: [
            { name: "Aponévrosite plantaire (fasciite plantaire) chronique post-traumatique", searchTerms: ["aponévrosite plantaire fasciite plantaire chronique post-traumatique", "fasciite plantaire", "aponévrosite plantaire", "talalgie plantaire", "épine calcanéenne", "inflammation aponévrose plantaire"], rate: [5, 15], description: "Inflammation chronique de l'aponévrose plantaire, douleurs talalgies.", rateCriteria: { low: "Douleurs matinales résiduelles, dérouillage court.", high: "Douleurs quasi-permanentes à la marche, limitation majeure de la station debout et de la marche." } },
            { name: "Syndrome du tunnel tarsien (compression nerf tibial postérieur)", searchTerms: ["syndrome tunnel tarsien compression nerf tibial postérieur", "tunnel tarsien", "compression nerf tibial", "nerf tibial postérieur", "paresthésies plantaires"], rate: [10, 25], description: "Compression du nerf tibial postérieur dans le tunnel tarsien (face interne cheville).", rateCriteria: { low: "Paresthésies plantaires intermittentes.", high: "Douleurs neuropathiques permanentes, hypoesthésie plantaire invalidante." } },
        ]
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Entrées pied manquantes (barème indicatif)
            { name: "Modifications des appuis plantaires avec hyperkératose douloureuse", searchTerms: ["modifications appuis plantaires hyperkératose douloureuse", "appuis plantaires hyperkératose", "hyperkératose plantaire douloureuse"], rate: [3, 10], description: "Modifications pathologiques des points d'appui du pied avec callosités douloureuses.", rateCriteria: { low: "Hyperkératose modérée, corrigible par semelles orthopédiques.", high: "Hyperkératose étendue, douloureuse, nécessitant soins podologiques fréquents et compliquant la marche." } },
            { name: "Modifications des appuis plantaires sans hyperkératose", searchTerms: ["modifications appuis plantaires sans hyperkératose", "appuis plantaires modifiés sans hyperkératose", "troubles appuis plantaires"], rate: 3, description: "Modifications des appuis plantaires sans lésion cutanée." },
            { name: "Ankylose sous-talienne et médio-tarsienne en bonne position", searchTerms: ["ankylose sous-talienne médio-tarsienne bonne position", "ankylose sous astragalienne médio tarsienne", "ankylose arrière pied bonne position"], rate: [10, 15], description: "Fusion des articulations sous-talienne et médio-tarsienne en position fonctionnelle." },
            { name: "Arthrodèse sous-talienne en bonne position", searchTerms: ["arthrodèse sous-talienne bonne position", "arthrodèse sous astragalienne", "fusion sous-talienne"], rate: [8, 10], description: "Fusion chirurgicale de l'articulation sous-talienne (sous-astragalienne)." },
            { name: "Ankylose tarso-métatarsienne (interligne de Lisfranc)", searchTerms: ["ankylose tarso-métatarsienne interligne lisfranc", "ankylose lisfranc", "ankylose tarso métatarsienne"], rate: [8, 15], description: "Fusion des articulations tarso-métatarsiennes (interligne de Lisfranc)." },
            { name: "Arthrodèse tarso-métatarsienne (interligne de Lisfranc)", searchTerms: ["arthrodèse tarso-métatarsienne interligne lisfranc", "arthrodèse lisfranc", "fusion chirurgicale lisfranc"], rate: [8, 12], description: "Fusion chirurgicale de l'interligne de Lisfranc." },
            { name: "Hallux rigidus post-traumatique", searchTerms: ["hallux rigidus post-traumatique", "hallux rigidus", "raideur métatarso-phalangienne gros orteil"], rate: [3, 5], description: "Raideur de l'articulation métatarso-phalangienne du gros orteil (luxation ou fracture séquellaire)." },
            { name: "Laxité chronique du pied — séquelle d'entorse bénigne", searchTerms: ["laxité chronique pied séquelle entorse bénigne", "entorse bénigne séquelle laxité", "laxité pied entorse bénigne"], rate: [0, 3], description: "Séquelle d'entorse bénigne du pied : instabilité résiduelle minime." },
            { name: "Laxité chronique du pied — post-traumatique documentée", searchTerms: ["laxité chronique pied post-traumatique documentée", "laxité chronique pied documentée", "laxité pied post-traumatique"], rate: [3, 6], description: "Laxité chronique du pied documentée cliniquement et radiologiquement après traumatisme." },
        ]
      },
      {
        ...
        injuries: [
            ...
            // 🆕 V3.3.267 - Amputations MI manquantes (barème indicatif)
            { name: "Amputation du gros orteil au 1er rayon (avec tête métatarsienne)", searchTerms: ["amputation gros orteil premier rayon tête métatarsienne", "amputation 1er rayon gros orteil", "amputation gros orteil rayon"], rate: [10, 12], description: "Amputation du gros orteil incluant la tête du 1er métatarsien — retentissement sur l'appui antérieur." },
            { name: "Amputation gros orteil — tête de la 1ère phalange seulement", searchTerms: ["amputation gros orteil tête première phalange", "amputation partielle gros orteil", "amputation tête P1 gros orteil"], rate: [7, 8], description: "Amputation partielle du gros orteil à la tête de la 1ère phalange." },
            { name: "Amputation de tous les orteils sauf le gros orteil", searchTerms: ["amputation tous orteils sauf gros orteil", "amputation quatre petits orteils", "amputation orteils latéraux"], rate: [8, 12], description: "Amputation des 2ème, 3ème, 4ème et 5ème orteils, gros orteil conservé." },
            { name: "Amputation transmétatarsienne du pied", searchTerms: ["amputation transmétatarsienne pied", "amputation transmétatarsienne", "amputation avant-pied transmétatarsienne"], rate: [18, 20], description: "Amputation au niveau de la diaphyse des métatarsiens — perte de l'avant-pied." },
            { name: "Amputation médiotarsienne du pied sans équin (bon talon)", searchTerms: ["amputation médiotarsienne pied sans équin bon talon", "amputation médiotarsienne", "amputation chopart sans équin"], rate: 25, description: "Amputation au niveau de l'articulation médio-tarsienne (Chopart), sans déformation en équin." },
            { name: "Amputation médiotarsienne du pied avec équin", searchTerms: ["amputation médiotarsienne pied avec équin", "amputation chopart avec équin", "amputation médiotarsienne équin"], rate: 30, description: "Amputation médiotarsienne avec déformation en équin du moignon." },
        ]
      },
      {
        ...
        injuries: [
            ...
            { name: "Troubles trophiques, œdème chronique, varices", searchTerms: ["troubles trophiques, œdème chronique, varices", "varices chronique, œdème trophiques, troubles", "troubles trophiques,", "trophiques, œdème", "œdème chronique,", "troubles trophiques", "oedeme chronique", "ulceres trophiques", "stase veineuse", "insuffisance veineuse"], rate: [5, 20] },
            ...
            // 🆕 V3.3.267 - Perte totale de locomotion (barème indicatif)
            { name: "Perte totale de la fonction de locomotion (fauteuil roulant)", searchTerms: ["perte totale fonction locomotion fauteuil roulant", "perte locomotion fauteuil", "fauteuil roulant perte locomotion", "perte totale marche"], rate: 65, description: "Perte totale de la capacité de marche nécessitant l'usage permanent d'un fauteuil roulant." },
        ]
      },
    ]
  },
    ...
    subcategories: [
      {
        ...
        injuries: [
          // 🆕 V3.3.267 - Brûlures < 10% surface corporelle (barème indicatif Chap. XIV)
          { 
            name: "Brûlures cutanées légères - Moins de 10% de la surface corporelle", 
            searchTerms: ["brûlures cutanées légères 10% surface corporelle", "brûlures moins 10 pourcent surface", "brûlures inférieures 10% surface", "brûlures légères"], rate: 5, 
            description: "Séquelles de brûlures couvrant moins de 10% de la surface corporelle totale."
          },
          { 
  ...
  },
  {
    ...
    subcategories: [
      ...
      // 🆕 V3.3.267 - Hypoparathyroïdie (barème indicatif Chap. X Endocrinologie)
      {
        name: "Troubles Parathyroïdiens",
        injuries: [
          { 
            name: "Hypoparathyroïdie post-chirurgicale ou post-traumatique", 
            searchTerms: ["hypoparathyroïdie post-chirurgicale post-traumatique", "hypoparathyroïdie", "hypocalcémie post-thyroïdectomie", "tétanie post-chirurgicale"], rate: [5, 15], 
            description: "Hypoparathyroïdie (déficit en PTH) après chirurgie thyroïdienne ou cervicale traumatique. Hypocalcémie chronique.",
            rateCriteria: { 
              low: "Hypoparathyroïdie bien contrôlée par supplémentation en calcium et vitamine D, asymptomatique.", 
              high: "Hypocalcémie sévère avec crises de tétanie récidivantes, difficile à équilibrer malgré le traitement."
            } 
          },
        ]
      }
