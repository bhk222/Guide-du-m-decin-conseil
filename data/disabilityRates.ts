    ...
    subcategories: [
      ...
      },
      {
       ...
       },
       {
        ...
        injuries: [
            ...
            { name: "Séquelles de fracture-luxation de Monteggia (Main Dominante)", rate: [15, 30], rateCriteria: { low: "Consolidation sans limitation majeure.", high: "Raideur et instabilité du coude, limitation prono-supination." }, description: "Fracture du tiers proximal du cubitus avec luxation antérieure de la tête radiale.", imageUrl: "/images/medical/monteggia.jpg", clinicalTip: "L'image montre la lésion caractéristique de Monteggia : fracture diaphysaire cubitale proximale avec luxation antérieure de la tête radiale (flèche rouge). Examiner : palpation tête radiale (saillie antérieure), mobilité coude (flexion-extension), prono-supination (souvent limitée), test instabilité radiale, recherche atteinte nerf radial (interosseux postérieur : déficit extension pouce/doigts), déformation cubitale résiduelle. Radiographies coude + avant-bras complètes obligatoires. Classification Bado (type I-IV) pour pronostic." },
      ...
      },
      {
        ...
        injuries: [
            ...
            { name: "Amputation totale des 5 doigts (main inutilisable)", rate: 60, description: "Équivalent perte de la main. Amputation de tous les doigts sans précision de dominance. Barème officiel." },
            { name: "Amputation du pouce - Désarticulation métacarpo-phalangienne", rate: 28, description: "Perte totale du pouce au niveau MCP. Barème officiel sans distinction dominance." },
            { name: "Amputation du pouce - Désarticulation inter-phalangienne", rate: 20, description: "Conservation de la base du pouce. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'index - Désarticulation métacarpo-phalangienne", rate: 15, description: "Amputation totale index au niveau MCP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'index - Désarticulation 1ère phalange", rate: 12, description: "Amputation index au niveau IPP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'index - Désarticulation 2ème phalange", rate: 8, description: "Amputation index au niveau IPD. Barème officiel sans distinction dominance." },
            { name: "Amputation du médius - Désarticulation métacarpo-phalangienne", rate: 12, description: "Amputation totale médius au niveau MCP. Barème officiel sans distinction dominance." },
            { name: "Amputation du médius - Désarticulation 1ère phalange", rate: 10, description: "Amputation médius au niveau IPP. Barème officiel sans distinction dominance." },
            { name: "Amputation du médius - Désarticulation 2ème phalange", rate: 6, description: "Amputation médius au niveau IPD. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'annulaire - Désarticulation métacarpo-phalangienne", rate: 10, description: "Amputation totale annulaire au niveau MCP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'annulaire - Désarticulation 1ère phalange", rate: 8, description: "Amputation annulaire au niveau IPP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'annulaire - Désarticulation 2ème phalange", rate: 5, description: "Amputation annulaire au niveau IPD. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'auriculaire - Désarticulation métacarpo-phalangienne", rate: 8, description: "Amputation totale auriculaire au niveau MCP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'auriculaire - Désarticulation 1ère phalange", rate: 6, description: "Amputation auriculaire au niveau IPP. Barème officiel sans distinction dominance." },
            { name: "Amputation de l'auriculaire - Désarticulation 2ème phalange", rate: 4, description: "Amputation auriculaire au niveau IPD. Barème officiel sans distinction dominance." },
        ]
      },
      {
