    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Splénectomie totale - Résultat excellent (cicatrice bonne, formule sanguine normale)", searchTerms: ["splénectomie totale résultat excellent cicatrice bonne, formule sanguine normale", "rate totale résultat excellent cicatrice bonne, formule sanguine normale", "normale sanguine formule bonne, cicatrice excellent résultat totale splénectomie", "splénectomie totale", "totale résultat"], rate: [5, 8], description: "Splénectomie post-traumatique avec bonne cicatrice, pas de modification de la formule sanguine, pas de complications. Note: la splénectomie n'entraîne pas de diminution de la longévité." },
          { name: "Splénectomie totale - Avec complications (cicatrice insuffisante, éventration, modifications formule)", searchTerms: ["splénectomie totale avec complications cicatrice insuffisante, éventration, modifications formule", "rate totale avec complications cicatrice insuffisante, éventration, modifications formule", "formule modifications éventration, insuffisante, cicatrice complications avec totale splénectomie", "splénectomie totale complications cicatrice insuffisante, éventration, modifications formule", "splénectomie totale"], rate: [15, 30], description: "Splénectomie avec cicatrice de mauvaise qualité, éventration associée, ou modifications importantes de la formule sanguine (thrombocytose, leucocytose). Ce taux couvre tous les éléments de préjudice." },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
            { name: "Fracture du massif trochantérien - Bonne consolidation", searchTerms: ["fracture massif trochantérien bonne consolidation", "consolidation bonne trochantérien massif fracture", "fracture massif", "massif trochantérien", "trochantérien bonne"], rate: [5, 10], rateCriteria: { low: "Consolidation anatomique sans séquelle, gêne minime.", high: "Consolidation avec légère raideur et douleurs mécaniques." } },
