    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Syndrome de Brown-Séquard", rate: [15, 80], description: "Hémisection médullaire avec atteinte motrice d'un hémicorps et troubles anesthésiques croisés.", rateCriteria: { low: "Atteinte fruste: 15-20%. Signes modérés avec conservation fonctionnelle.", medium: "Atteinte intermédiaire: 30-50%. Déficit moteur modéré et troubles sensitifs croisés nets.", high: "Atteinte totale: 60-80%. Atteinte motrice importante de l'hémicorps et troubles anesthésiques croisés sévères." } },
