    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Contusions cérébrales avec signes de localisation (hémiparésie, aphasie...)", searchTerms: ["contusions cérébrales avec signes de localisation hémiparésie aphasie", "hémiparésie aphasie localisation signes avec cérébrales contusions", "contusions cérébrales signes localisation", "contusions cérébrales", "hémiparésie aphasie"], description: "À évaluer avec les blessures du cerveau.", rate: [5, 60], rateCriteria: { low: "Séquelles minimes (ex: parésie légère, dysarthrie discrète).", medium: "Hémiparésie légère avec troubles cognitifs associés, vertiges et céphalées chroniques, limitation fonctionnelle modérée.", high: "Séquelles importantes (hémiparésie invalidante, aphasie sévère)." } },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Chylothorax chronique post-traumatique", searchTerms: ["chylothorax chronique post traumatique", "chylothorax traumatique thorax", "chylothorax pleural"], rate: [20, 40], rateCriteria: { low: "Bien contrôlé par régime, sans retentissement nutritionnel majeur.", high: "Chylothorax abondant, récidivant, nécessitant des ponctions ou une chirurgie, avec dénutrition." } },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Élongation musculaire de l'épaule (Main Dominante)", searchTerms: ["élongation musculaire épaule main dominante", "élongation épaule", "élongation musculaire épaule", "elongation musculaire epaule", "muscle épaule", "elongation muscle epaule", "musculaire de l epaule", "elongation musculaire de l epaule", "musculaire epaule gauche", "musculaire epaule droit"], rate: [5, 12], description: "Élongation ou déchirure partielle des muscles de l'épaule (deltoïde, supra-épineux, infra-épineux, etc.), entraînant des douleurs et une limitation de force.", rateCriteria: { low: "Douleurs légères, force quasi-normale.", medium: "Douleurs modérées, perte de force 20-30%.", high: "Douleurs persistantes, perte de force >30%, limitation mobilité." } },
          { name: "Élongation musculaire de l'épaule (Main Non Dominante)", searchTerms: ["élongation musculaire épaule main non dominante", "élongation épaule", "élongation musculaire épaule", "elongation musculaire epaule", "muscle épaule", "elongation muscle epaule", "musculaire de l epaule", "elongation musculaire de l epaule", "musculaire epaule gauche", "musculaire epaule droit"], rate: [4, 10], description: "Élongation ou déchirure partielle des muscles de l'épaule.", rateCriteria: { low: "Douleurs légères.", medium: "Douleurs modérées avec perte de force.", high: "Douleurs persistantes avec limitation fonctionnelle." } },
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
            ...
            { name: "Cal vicieux d'un métatarsien", searchTerms: ["cal vicieux d'un métatarsien", "métatarsien d'un vicieux cal", "cal vicieux métatarsien", "métatarsien cal vicieux", "d'un métatarsien"], rate: [5, 10], rateCriteria: { low: "Cal vicieux modéré sans impact fonctionnel majeur.", high: "Cal vicieux important avec métatarsalgie et troubles de l'appui." }, description: "Consolidation vicieuse d'une fracture métatarsienne." },
