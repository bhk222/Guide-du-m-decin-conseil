    ...
    subcategories: [
      {
        ...
        injuries: [
          ...
          { 
            name: "Doigt en maillet (mallet finger) IPD (Dominante)", 
            rate: [3, 8], 
            description: "Rupture tendon extenseur terminal, IPD en flexion permanente.",
            imageUrl: "/images/medical/Doigt en maillet.svg",
            clinicalTip: "Vérifier : impossibilité d'extension active de l'IPD (interphalangienne distale) avec flexion permanente. Tester l'extension passive (possible) vs active (impossible). Rechercher une avulsion osseuse sur la radiographie. Mesurer le déficit d'extension en degrés."
          },
          { 
            name: "Doigt en boutonnière (IPP fléchie, IPD hyperextension) (Dominante)", 
            rate: [8, 15], 
            description: "Rupture bandelette médiane extenseur.", 
            imageUrl: "/images/medical/mus_boutonniere_fr.svg",
          ...
          { 
            name: "Doigt en col de cygne (IPP hyperextension, IPD flexion) (Dominante)", 
            rate: [8, 15], 
            description: "Rétraction de l'intrinsèque ou laxité volaire.",
            imageUrl: "/images/medical/mus_boutonniere_fr.svg",
            clinicalTip: "Vérifier : hyperextension IPP + flexion IPD (inverse de la boutonnière). Tester la stabilité de l'IPP en flexion contrariée. Rechercher un ressaut ou une instabilité. Évaluer la force de préhension et la coordination fine."
          },
          ...
          { 
            name: "Doigt en maillet (mallet finger) IPD (Non-Dominante)", 
            rate: [2, 6], 
            description: "Rupture tendon extenseur terminal, IPD en flexion permanente.",
            imageUrl: "/images/medical/Doigt en maillet.svg",
            clinicalTip: "Vérifier : impossibilité d'extension active de l'IPD (interphalangienne distale) avec flexion permanente. Tester l'extension passive (possible) vs active (impossible). Rechercher une avulsion osseuse sur la radiographie. Mesurer le déficit d'extension en degrés."
          ...
          { 
            name: "Doigt en col de cygne (IPP hyperextension, IPD flexion) (Non-Dominante)", 
            rate: [6, 12], 
            description: "Rétraction de l'intrinsèque ou laxité volaire.",
            imageUrl: "/images/medical/mus_boutonniere_fr.svg",
            clinicalTip: "Vérifier : hyperextension IPP + flexion IPD (inverse de la boutonnière). Tester la stabilité de l'IPP en flexion contrariée. Rechercher un ressaut ou une instabilité. Évaluer la force de préhension et la coordination fine."
    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Déformation du pied en varus ou valgus post-traumatique", rate: [15, 40], description: "Déviation axiale du pied créant troubles statiques et marche pathologique.", rateCriteria: { low: "Déformation modérée compensée par orthèse.", high: "Déformation majeure, appui douloureux, boiterie importante." }, imageUrl: "/images/medical/varus-valgus.jpg", clinicalTip: "L'image montre 3 configurations en vue postérieure : 1️⃣ PIED VALGUS (éversion) : calcanéum dévié vers l'extérieur, tendon d'Achille en courbure externe, affaissement voûte plantaire, appui sur bord interne du pied, usure externe des chaussures. 2️⃣ PIED NORMAL : calcanéum axe vertical, tendon d'Achille rectiligne, voûte plantaire préservée, angle de Djian-Annonier 5°. 3️⃣ PIED VARUS (inversion) : calcanéum dévié vers l'intérieur, tendon d'Achille rectiligne médial, accentuation voûte plantaire, appui sur bord externe du pied, usure interne des chaussures. Examiner : empreinte podographique, test réductibilité sur pointe, radiographies en charge indispensables." },
          ...
          { name: "Pied équin post-traumatique", rate: [20, 40], description: "Pied en flexion plantaire permanente (marche sur la pointe), après rétraction tendineuse ou lésion neurologique.", imageUrl: "/images/medical/pied-varus-equin.jpg", clinicalTip: "Vérifier : angle tibio-tarsien (flexion plantaire permanente > 20°), impossibilité de ramener pied à angle droit (test dorsiflexion passive), rétraction tendon d'Achille, marche sur avant-pied (pointe), absence appui talonnier, durillons sous têtes métatarsiennes, compensation genou (flexum/recurvatum), boiterie majeure. Évaluer réductibilité (passif) vs irréductibilité (arthrogène)." },
          { name: "Hallux valgus (oignon) post-traumatique symptomatique", rate: [5, 15], description: "Déviation du gros orteil vers l'extérieur avec bursite et douleurs.", imageUrl: "/images/medical/Hallux-Valgus.jpg", clinicalTip: "Vérifier : angle M1-P1 > 15° (normal < 15°), angle inter-métatarsien M1-M2 > 9° (normal < 9°), déformation en Z de la 1ère colonne, bursite (oignon) en regard de la tête M1, griffe compensatrice du gros orteil, durillons plantaires sous M2-M3 (transfert d'appui), conflit chaussage, douleurs à la marche. Mesure radiographique indispensable pour évaluation objective." },
