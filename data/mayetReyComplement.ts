    ...
    subcategories: [
      ...
      },
      {
        ...
        injuries: [
          ...
          { name: "Déformation du pied en varus ou valgus post-traumatique", rate: [15, 40], description: "Déviation axiale du pied créant troubles statiques et marche pathologique.", rateCriteria: { low: "Déformation modérée compensée par orthèse.", high: "Déformation majeure, appui douloureux, boiterie importante." }, imageUrl: "/images/medical/pied-varus-equin.jpg", clinicalTip: "Vérifier : axe du calcénéum (varus si inversion, valgus si éversion), angle tibio-tarsien, appui plantaire (empreinte podographique), déformations associées (griffe orteils, hallux valgus), bursite calcénéenne (Haglund), conflits chaussage, boiterie, usure anormale des chaussures. Radiographies en charge indispensables pour mesure angles et bilan articulaire." },
