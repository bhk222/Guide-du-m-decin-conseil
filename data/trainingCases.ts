...
export const trainingCases: TrainingCase[] = [
  ...
  },
  {
    ...
    expectedInjury: "Amputation du pouce (main dominante)",
    expectedRate: 20,
    severity: "fixe",
  ...
  // ========================================
  {
    ...
    expectedInjury: "Amputation de l'index (main dominante)",
    expectedRate: 10,
    severity: "fixe",
  ...
  },
  {
    ...
    expectedInjury: "Section des tendons fléchisseurs d'un doigt long",
    expectedRate: 8,
    severity: "moyen",
  ...
  },
  {
    ...
    expectedInjury: "Acouphènes post-traumatiques invalidants",
    expectedRate: 8,
    severity: "moyen",
  ...
  // ========================================
  {
    ...
    expectedInjury: "Perte de dents définitives",
    expectedRate: 12,
    severity: "moyen",
