...
/**
 * BASE DE DONNÉES IPP - HIÉRARCHIE DES BARÈMES
 * 
 * 1️⃣ RÉFÉRENCE PRINCIPALE : Barème Algérien 1967 (Législation officielle)
 *    - Arrêté du 5 janvier 1967
 *    - Base légale obligatoire pour l'évaluation IPP en Algérie
 *    - Placé en PREMIÈRE position pour recherche prioritaire
 * 
 * 2️⃣ RÉFÉRENCE COMPLÉMENTAIRE : Barème MAYET & REY (EXHAUSTIF)
 *    - Utilisé pour les lésions NON prévues dans le barème 1967
 *    - Séquelles neurologiques complexes, psychiatriques, sensorielles
 *    - Lésions articulaires détaillées (doigts, poignet, épaule, coude, hanche, genou, cheville)
 *    - Placé en SECONDE position
 *    - +200 lésions supplémentaires ajoutées
 */

export const disabilityData: InjuryCategory[] = [
  // ========== BARÈME ALGÉRIEN 1967 - RÉFÉRENCE PRINCIPALE ==========
  ...algerianBareme1967,
  
  // ========== BARÈME MAYET & REY - RÉFÉRENCE COMPLÉMENTAIRE ==========
  {
  ...
  // ========== BARÈME MAYET & REY - COMPLÉMENT EXHAUSTIF ==========
  ...mayetReyComplement,
];
